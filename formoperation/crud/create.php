...
$desc=$_POST['desc'];
$sql ="insert into all_field(username,dob,gender,country,subject,description) values('$uname','$dob','$gender','$country','$subject','$desc')";
            ...
            <form action="" method="post">
                ...
                <div class="input-row">
                    ...
                    <div class="input-box">
                       ...
                       <textarea name="desc" id=""  class="reg-input"></textarea>
                    </div>
                ...
                <!-- <div class="input-row">
                    ...
                    <div class="input-box">
                        ...
                        <input type="number"  name="adhar"  class="reg-input">
                    </div>
                    <div class="input-box">
